...
public class ClienteTeste {
	...
	public void deveTestarClienteNullo() {
		...
		try {
			...
			new Cliente(1L, null, null, contatoTeste, enderecoTeste);

		} catch (DominioInvalido dominioInvalido) {
			Assertions.assertEquals(
					"[contato.email : e-mail nao pode ser vazio, contato.telefone : telefone nao pode ser vazio, cpfCliente : CPF nao pode ser vazio, endereco.bairro : Bairro nao pode ser vazio, endereco.cep : Cep nao pode ser vazio, endereco.cidade : cidade nao pode ser vazio, endereco.estado : estado nao pode ser vazio, endereco.numero : Numero nao pode ser vazio, endereco.rua : Rua nao pode ser vazio, nomeCliente : nome do cliente nao pode ser vazio]",
